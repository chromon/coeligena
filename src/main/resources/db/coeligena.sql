...
CREATE TABLE IF NOT EXISTS auth_users (
    id              INT(11)      NOT NULL AUTO_INCREMENT, /* 验证用户 ID（唯一标识） */
    email           VARCHAR(128) NOT NULL, /* 邮箱*/
    phone           VARCHAR(16)           DEFAULT '', /* 手机 */
...
CREATE TABLE IF NOT EXISTS role_auth_user (
    ...
    role_id      INT(11) NOT NULL DEFAULT '0', /* 角色 ID（唯一标识） */
    auth_user_id INT(11) NOT NULL DEFAULT '0', /* 验证用户 ID（唯一标识） */
    PRIMARY KEY (id),
    INDEX (role_id),
    INDEX (auth_user_id)
);
...
CREATE TABLE IF NOT EXISTS permissions (
    id          INT(11)     NOT NULL AUTO_INCREMENT, /* 权限 ID（唯一标识） */
    name        VARCHAR(32) NOT NULL, /* 权限名称（英文名，对应应用控制器、应用、方法名） */
    title       VARCHAR(64)          DEFAULT '', /* 权限名称 */
    status      TINYINT(4)           DEFAULT '1', /* 启用状态：0-表示禁用，1-表示启用 */
    remark      VARCHAR(256)         DEFAULT '', /* 备注信息 */
    sort        INT(11)              DEFAULT '50', /* 排序值（默认值为50） */
    pid         INT(11)     NOT NULL DEFAULT '0', /* 父权限 ID（如:方法pid对应相应的控制器） */
...
CREATE TABLE IF NOT EXISTS role_permission (
    id            INT(11) NOT NULL AUTO_INCREMENT,
    role_id       INT(11) NOT NULL DEFAULT '0', /* 角色 ID（唯一标识） */
    permission_id INT(11) NOT NULL DEFAULT '0', /* 权限 ID（唯一标识） */
    PRIMARY KEY (id),
    INDEX (role_id),
    INDEX (permission_id)
);
...
CREATE TABLE IF NOT EXISTS users (
    ...
    avatar_path        VARCHAR(512)         DEFAULT '', /* 头像路径 */
    location           VARCHAR(128)         DEFAULT '', /* 居住位置 */
    business_id        INT(11)              DEFAULT '0', /* 所属行业 ID */
    employment         VARCHAR(128)         DEFAULT '', /* 公司或组织名称 */
    position           VARCHAR(128)         DEFAULT '', /* 职位 */
...
CREATE TABLE IF NOT EXISTS activations (
    id                   INT(11)     NOT NULL AUTO_INCREMENT, /* 账户激活数据 ID */
...
CREATE TABLE IF NOT EXISTS questions (
    ...
    locked           TINYINT(4)   NOT NULL DEFAULT '0', /* 是否被锁定 1：是， 0：否 */
    anonymous        TINYINT(4)   NOT NULL DEFAULT '0', /* 是否匿名 1：是， 0：否 */
    recommend        TINYINT(4)   NOT NULL DEFAULT '0', /* 是否是推荐问题 1：是，0：否 */
...
CREATE TABLE IF NOT EXISTS topic_nodes (
    ...
    merged_to          TINYINT(4)   NOT NULL DEFAULT '0', /* 是否合并到其他节点 0：否，1：是*/
    PRIMARY KEY (id),
    INDEX (topic_name)
);
...
CREATE TABLE IF NOT EXISTS topic_lock (
    ...
    locked_all          TINYINT(4) NOT NULL DEFAULT '0', /* 是否完全锁定 0：是，1：否 */
    locked_name         TINYINT(4) NOT NULL DEFAULT '0', /* 是否锁定话题名称 0：是，1：否 */
    locked_introduction TINYINT(4) NOT NULL DEFAULT '0', /* 是否锁定话题描述 0：是，1：否 */
    locked_image        TINYINT(4) NOT NULL DEFAULT '0', /* 是否锁定话题图片编辑 0：是，1：否 */
    locked_parent       TINYINT(4) NOT NULL DEFAULT '0', /* 是否锁定父话题 0：是，1：否 */
    locked_child        TINYINT(4) NOT NULL DEFAULT '0', /* 是否锁定子话题 0：是，1：否 */
    topic_id            INT(11)    NOT NULL DEFAULT '0', /* 话题 ID */
    PRIMARY KEY (id),
    INDEX (topic_id)
);
...
CREATE TABLE IF NOT EXISTS answers (
    ...
    sec_licence    TINYINT(4)       NOT NULL DEFAULT '0', /* 是否作者保留权利 */
    top_answer     TINYINT(4)       NOT NULL DEFAULT '0', /* 是否是精华回答 */
    anonymous      TINYINT(4)       NOT NULL DEFAULT '0', /* 是否匿名 1：是， 0：否 */
...
CREATE TABLE IF NOT EXISTS drafts (
    ...
    anonymous     TINYINT(4) NOT NULL DEFAULT '0', /* 草稿是否匿名 1：是， 0：否 */
...
CREATE TABLE IF NOT EXISTS settings (
    id                 INT(11)    NOT NULL AUTO_INCREMENT, /* 设置 ID（唯一标识） */
    privacy_protection TINYINT(4) NOT NULL DEFAULT '1', /* 是否隐私保护（站外搜索到我的内容，不会被显示姓名）0：否，1：是 */
...
CREATE TABLE IF NOT EXISTS columns (
    id                     INT(11)      NOT NULL AUTO_INCREMENT, /* 专栏表 ID（唯一标识） */
    column_name            VARCHAR(128) NOT NULL, /* 专栏名称 */
    column_intro           VARCHAR(256) NOT NULL, /* 专栏介绍 */
    ...
    locked                 TINYINT(4)   NOT NULL DEFAULT '0', /* 专栏是否被锁定 1：是，0：否 */
...
CREATE TABLE IF NOT EXISTS articles (
    id                  INT(11)      NOT NULL AUTO_INCREMENT, /* 专栏文章 ID（唯一标识） */
    article_title       VARCHAR(256) NOT NULL, /* 文章标题 */
    article_content     MEDIUMTEXT   NOT NULL, /* 文章正文 */
    title_image         VARCHAR(256)          DEFAULT '', /* 文章题图 */
    ...
    locked              TINYINT(4)   NOT NULL DEFAULT '0', /* 文章是否被锁定 1：是，0：否 */
...
CREATE TABLE IF NOT EXISTS column_topics (
    id            INT(11)     NOT NULL AUTO_INCREMENT, /* 专栏主题表ID（唯一标识） */
...
CREATE TABLE IF NOT EXISTS article_topics (
    id              INT(11) NOT NULL AUTO_INCREMENT, /* 专栏文章主题表ID（唯一标识） */
...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    unread           TINYINT(4)  NOT NULL DEFAULT '1', /* 是否未读 0:否 ，1：是  */
...
CREATE TABLE IF NOT EXISTS reports (
    ...
    resolved           TINYINT(4)   NOT NULL DEFAULT '0', /* 是否处理完成，1：是，0：否 */
...
CREATE TABLE IF NOT EXISTS pages (
    ...
    keywords    VARCHAR(256)         DEFAULT '', /* 页面关键字 */
    description VARCHAR(256)         DEFAULT '', /* 页面描述 */
