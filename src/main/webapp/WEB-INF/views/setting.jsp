        ...
        <div class="col-sm-12">
            <div class="custom-card">
                ...
                <ul class="nav nav-tabs custom-feed-item">
                    ...
                    <li class="active"><a href="#notification" data-toggle="tab">消息和邮件</a></li>
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade" id="account">
                        <div class="custom-setting-section">
                            <div class="custom-setting-item">
                                <form class="form-horizontal">
                                    <p class="custom-margin-left20">绑定手机和邮箱，并设置密码，帐号更安全。</p>
                                    <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="filter">
                        <div class="custom-setting-section">
                            <div class="custom-setting-item"></div>
                        </div>
    ...
    <%--<div class="row custom-content-margin">--%>
        <%--<div class="col-sm-12">--%>
            <%--<ul class="nav nav-tabs custom-tab-border custom-story-item custom-card">--%>
                <%--<li><a href="#profile2" data-toggle="tab">基本资料</a></li>--%>
                <%--<li><a href="#account2" data-toggle="tab">账号和密码</a></li>--%>
                <%--<li><a href="#notification2" data-toggle="tab">消息和邮件</a></li>--%>
                <%--<li><a href="#filter2" data-toggle="tab">屏蔽</a></li>--%>
                <%--<li><a href="#lab2" data-toggle="tab">实验室</a></li>--%>
            <%--</ul>--%>
            <%--<div id="myTabContent2" class="tab-content custom-margin-top20">--%>
                <%--<!-- profile tab -->--%>
                <%--<div class="tab-pane fade custom-story-item custom-card" id="profile2">--%>
                    <%--<form class="form-horizontal">--%>
                        <%--<div class="form-group">--%>
                            <%--<label class="col-sm-2 control-label">姓名</label>--%>
                            <%--<div class="col-sm-10">--%>
                ...
                <%--<!-- account tab -->--%>
                <%--<div class="col-sm-6 tab-pane fade active in custom-story-item custom-card" id="account2">--%>
                    <%--<form class="form-horizontal">--%>
                ...
                <%--<!-- notification tab -->--%>
                <%--<div class="col-sm-9 tab-pane fade custom-story-item custom-card" id="notification2">--%>
                    <%--<form class="form-horizontal">--%>
                        <%--<h5>私信设置</h5>--%>
                        <%--<div class="form-group">--%>
                ...
                <%--<!-- filter tab -->--%>
                <%--<div class="col-sm-9 tab-pane fade custom-story-item custom-card" id="filter2">--%>
                    <%--<form class="form-horizontal">--%>
                        <%--<h5>屏蔽话题设置</h5>--%>
